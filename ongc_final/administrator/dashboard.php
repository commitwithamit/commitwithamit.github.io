        ...
        <div class="post-container">
          ...
          <div class="emp-pro-img-con">
            <span class="pro-img-con">
              <a href="user-profile.php?pro_id=<?=$post['user_id']?>">
                <!-- poster's pro-pic -->
                <?php
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <button class="btn btn-danger confirm-flag" data-user="<?=$post['user_id']?>" data-post="<?=$post['post_id']?>" data-time="<?=$post["posting_time"]?>">Yes, flag it.</button>
              ...
              ?>
                ...
                <div class="com-list" id="com-del-<?=$com['comment_id']?>">
                  <div class="com-pro-pic">
                    <!-- commentor's pro pic -->
                    <a href="user-profile.php?pro_id=<?=$com['user_id']?>">
                      <?php
