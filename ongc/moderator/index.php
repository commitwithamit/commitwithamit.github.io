...
if($_POST){
    ...
    if(!empty($cpf_no) && !empty($pass)){
        ...
        $query = mysqli_query($db_connect, "select * from ongc_admin where cpf = '$cpf_no' and password = '$encode_pass'");
        ...
        <div class="box">
            ...
            <form action="index.php" method="POST" class="form-pd">
                ...
                <div class="group">
                    ...
                    <input type="text" class="form-control <?=$outline_p?>" name="password" id="pass">
