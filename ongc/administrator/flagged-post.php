          ...
          <div class="post-container">
            ...
            <div class="emp-pro-img-con">
              ...
              <span id="post-options">
                  <!-- flag post option -->
                  <i class="bi bi-flag-fill flag-icon" data-bs-toggle="modal"
                      data-bs-target="#flag-<?=$post['post_id']?>"></i>
                  <!-- delete post confirmation modal box -->
                  <div class="modal fade" id="flag-<?=$post['post_id']?>" tabindex="-1"
                      ...
                      <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                  ...
                                  <button class="btn btn-danger confirm-flag" data-user="<?=$post['user_id']?>"
                                      data-post="<?=$post['post_id']?>" data-time="<?=$post["posting_time"]?>">Yes,
                                      flag it.</button>
